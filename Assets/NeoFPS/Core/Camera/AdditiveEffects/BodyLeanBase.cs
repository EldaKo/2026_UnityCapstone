        ...
        public virtual void UpdateTransform()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (m_MotionController != null)
                    {
                        float resetSpeed = m_ResetSpeedStanding;
                        if (m_IsCrouchingSwitch != null && m_IsCrouchingSwitch.on)
                            resetSpeed = Mathf.Lerp(m_ResetSpeedCrouching, m_ResetSpeedStanding, m_MotionController.currentHeightNormalised * 2f -1f);
