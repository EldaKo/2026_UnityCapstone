...
namespace NeoFPSEditor.Hub.Pages.ItemCreationWizards
{
    public class ThrownWeaponWizard : NeoFpsWizard
    {
        ...
        public override void CreateItem()
        {
            ...
            // Remove camera and audio listener components
            var cameras = viewModelObject.GetComponentsInChildren<Camera>(true);
            foreach (var c in cameras)
                DestroyImmediate(c);
            var listeners = viewModelObject.GetComponentsInChildren<AudioListener>(true);
