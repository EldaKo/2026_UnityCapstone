...
namespace NeoFPS
{
    ...
    public class LockpickPopup3D : LockpickPopup, IPickAngleLockpickPopup
    {
...
#if NEOFPS_URP
        private Camera m_LockpickCamera = null;
        ...
        protected void OnDisable()
        {
            ...
            {
                var cameraData = m_CharacterCamera.GetUniversalAdditionalCameraData();
                cameraData.cameraStack.Remove(m_LockpickCamera);
...
#if NEOFPS_URP
            m_LockpickCamera = GetComponentInChildren<Camera>(true);

            var cameraData = character.fpCamera.unityCamera.GetUniversalAdditionalCameraData();
            cameraData.cameraStack.Add(m_LockpickCamera);
#endif
        }
