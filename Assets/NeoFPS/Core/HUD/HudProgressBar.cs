...
namespace NeoFPS
{
	...
	public class HudProgressBar : PlayerCharacterHudBase
    {
        ...
        [SerializeField, Tooltip("Should the progress bar change colour along with the crosshair.")]
        private bool m_MatchCrosshairColor = true;
        ...
        {
            base.Start();
            if (m_FullBar != null && m_MatchCrosshairColor)
            {
                // Add event handlers
