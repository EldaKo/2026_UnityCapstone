...
namespace NeoFPS.SinglePlayer
{
    public abstract class FpsSoloGameBase : FpsGameMode
    {
        ...
        private bool m_LoadedFromSave = false;
        ...
        protected override void OnStart()
        {
            ...
            else
            {
                ...
                if (character.gameObject.scene != gameObject.scene)
                ...
                if (!m_LoadedFromSave)
                {
                    ...
                    if (spawn != null)
                    {
                        ...
                        character.motionController.characterController.Teleport(spawn.spawnTransform.position, spawn.spawnTransform.rotation, false);
