...
{
    [HelpURL("https://docs.neofps.com/manual/weaponsref-mb-healtoolaction.html")]
    public class HealToolAction : BaseWieldableToolModule, IDamageSource
    {
        ...
        [SerializeField, Tooltip("How long to block after the heal to prevent the tool immediately deselecting.")]
        private int m_PostHealTime = 0;
        ...
        private int m_PostHealCountDown = 0;
        ...
        {
            get { return m_StartCountDown > 0 || m_PostHealCountDown > 0; }
        }
        ...
        public override bool blocking
        {
            get
            {
                ...
                return (subject == null || subject.health >= subject.healthMax - 0.0001f || m_StartCountDown > 0 || m_PostHealCountDown > 0);
            }
        }
        ...
        public override void FireStart()
        {
            if (m_StartDelay == 0)
            {
                m_PostHealCountDown = m_PostHealTime;
