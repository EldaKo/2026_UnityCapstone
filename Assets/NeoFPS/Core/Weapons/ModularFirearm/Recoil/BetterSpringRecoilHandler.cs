...
namespace NeoFPS.ModularFirearms
{
    ...
    public class BetterSpringRecoilHandler : BaseRecoilHandlerBehaviour
    {
        ...
        public class RecoilProfile
        {
            ...
            [Range(0, 1f), Tooltip("How much of the head/body recoil should return to its original position. Values below 1 will redirect some of the recoil to the character's aim controller.")]
        ...
        private IEnumerator RecoilInternal(RecoilProfile p)
        {
            ...
            if (m_BodyRecoilEffect != null)
            {
                ...
                bodyRecoil *= recoilMultiplier;
                m_BodyRecoilEffect.AddRecoil(bodyRecoil, p.duration, p.recoilSpringCurve, p.springReturn);
            }
            ...
            if (m_WeaponRecoilEffect != null)
            {
                ...
                m_WeaponRecoilEffect.AddRecoil(
                    ...
                    p.pushBack * recoilMultiplier, p.maxPushBack, p.weaponPushCurve,
                    jiggle * recoilMultiplier, p.weaponJiggleCurve,
                    p.duration
                    );
            }
        }
