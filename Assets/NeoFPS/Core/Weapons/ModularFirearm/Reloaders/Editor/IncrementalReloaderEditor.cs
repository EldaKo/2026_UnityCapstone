...
namespace NeoFPSEditor.ModularFirearms
{
    ...
    public class IncrementalReloaderEditor : BaseReloaderEditor
    {
        protected override void InspectReloaderSettings()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_StartIncludesReload"));
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_ReloadSpeedParameter"));
