...
namespace NeoFPS
{
    ...
    public class SingleAnimatorHandler : IWieldableAnimationHandler
    {
        ...
        {
            get { return m_Animator.cullingMode; }
            set { m_Animator.cullingMode = value; }
        }
    }
    ...
    public class NullAnimatorHandler : IWieldableAnimationHandler
    {
        ...
        public AnimatorCullingMode cullingMode
        {
            get { return AnimatorCullingMode.AlwaysAnimate; }
            set { }
        }
    }
        ...
        public AnimatorCullingMode cullingMode
        {
            get
            {
                if (m_Animators != null && m_Animators.Length > 0)
                    return m_Animators[0].cullingMode;
                else
            ...
            {
                for (int i = 0; i < m_Animators.Length; ++i)
                    m_Animators[i].cullingMode = value;
            }
        }
    }
}