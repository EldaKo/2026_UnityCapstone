...
namespace NeoFPS
{
    ...
    public class NeoFpsInputManager : NeoFpsInputManagerBase
    {
        protected override void Initialise()
        {
            ...
            Debug.LogError("Old input manager based NeoFpsInputManager is active in your project. Either add the Input Manager (Legacy) to your player settings, or import the NeoFPS Input System extension.");
#endif
        }
