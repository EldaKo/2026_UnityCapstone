...
namespace NeoFPS
{
    ...
    public class FpsInventoryQuickUseItem : FpsInventoryItemBase, IQuickSlotItem
    {
        ...
        public virtual bool isUsable
        {
            get
            {
                return !m_DestroyOnDeselect && m_State == State.Idle && !slots.isLocked && (slots.selected == null || slots.selected.wieldable == null || !slots.selected.wieldable.isBlocked) && CanUseWieldable();
            }
        }
        ...
        protected virtual bool CanUseWieldable()
        {
            ...
            if (m_WieldableTool != null)
                return m_WieldableTool.CheckCanUse();
            return true;
        }
