...
namespace NeoFPS
{
    ...
    public class FpsInventorySwappable : FpsInventoryBase
	{
		...
		public override DuplicateEntryBehaviourFull duplicateBehaviour
		{
			get { return m_DuplicateBehaviour; }
		}

		public override SwapAction swapAction
		{
        ...
        protected override bool IsEquippableItem(int index)
        {
            CheckInitialised();
            ...
            if (item == null)
                return false;
            if (item is FpsInventoryQuickUseSwappableItem)
                return false;
            if (item is FpsInventoryInstantUseSwappableItem)
                return false;
