...
namespace NeoFPSEditor
{
    public class NeoFpsEditorPrefs : ScriptableObject
    {
        ...
        [SerializeField]
        private bool m_Unity6Checked = false;
        [SerializeField]
        ...
        static NeoFpsEditorPrefs GetPreferences()
        {
            ...
            var guids = AssetDatabase.FindAssets("t:NeoFpsEditorPrefs");
            ...
            else
            {
                ...
                guids = AssetDatabase.FindAssets("t:MonoScript NeoFpsInternalStartup");
                if (guids != null && guids.Length > 0)
                    return null;
        ...
        public static bool unity6Checked
        {
            get
            {
                var prefs = GetPreferences();
                if (prefs != null)
                    return prefs.m_Unity6Checked;
                else
                    return false;
            }
            set
            {
                var prefs = GetPreferences();
                if (prefs != null && prefs.m_Unity6Checked != value)
                {
                    prefs.m_SerializedObject.FindProperty("m_Unity6Checked").boolValue = value;
                    prefs.m_SerializedObject.ApplyModifiedPropertiesWithoutUndo();
                }
            }
        }
