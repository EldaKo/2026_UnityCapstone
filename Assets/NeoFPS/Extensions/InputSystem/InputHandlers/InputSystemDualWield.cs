...
namespace NeoFPS
{
    [HelpURL("https://docs.neofps.com/manual/inputref-mb-inputsystemdualwield.html")]
    public class InputSystemDualWield : FpsInputSystemHandler
    {
#if ENABLE_INPUT_SYSTEM
        ...
        void ApplyFirearmInput(ModularFirearm firearm, InputAction fireButton, bool reload, bool switchModes)
        {
            ...
            if (m_Style == DualWieldStyle.TogetherPlusAim)
            {
                firearm.aimToggleHold.SetInput(
                    GetButtonDown(controls.Combat.AimToggle),
                    GetButton(controls.Combat.Aim)
                    );
                if (m_AimProperty != null)
        ...
        void ApplyInput (WeaponInfo weaponInfo, bool left, bool reload, bool switchModes)
        {
            ...
            InputAction fireButton = controls.Combat.PrimaryFire;
            switch (m_Style)
            {
                case DualWieldStyle.PrimarySecondary:
                    if (!left)
                        fireButton = controls.Combat.SecondaryFire;
                    break;
                ...
                case DualWieldStyle.TogetherPlusAim:
                    fireButton = controls.Combat.PrimaryFire;
                    break;
            }
