...
namespace NeoFPS
{
    ...
    [HelpURL("https://docs.neofps.com/manual/inputref-mb-inputsystemabilitywieldabletool.html")]
    public class InputSystemAbilityWieldableTool : FpsInputSystemHandler
    {
        ...
        protected override void UpdateInput()
        {
            ...
            if (GetButtonUp(controls.Combat.Ability))
                m_WieldableTool.PrimaryRelease();
        }
